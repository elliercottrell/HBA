  ...
  return (
    <div className="App">
      ...
      <p>
        ...
        made possible by Code First Girls, demonstrates our how our coding skills have developed.
      </p>
      <p>
        The site itslef is designed to allow diabetic children to monitor there condition independently. It 
        provides a way for children to calculate the amount of insulin they need based on current sugar levels
        and what they plan to eat. These values can they be saved and monitored over time by both the child 
        and their parent.
      </p>
      <p>
